function solve() {
    ...
    function addPet(event) {
        ...
        if (name == '' || input.age.value.trim() == '' || Number.isNaN(age) || kind == '' || owner == '') {
            return; // tova se naricha early exit, funkciqta shte returne undefined i shte spre da se izpalnqva nadolu
        }
    ...
    // tova dolu e funkciq za sazdavane na HTML elementi !!!! moje da q polzvam za ulesnenie
